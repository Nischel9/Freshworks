...
public class Main{
    ...
    public Main(String path){
        ...
        if(!dir.mkdir()){                       //if mkdir() returns false display error and call main function
            System.out.println("Error : cannot create datastore");
        }
    ...
    public void create(String path){
        ...
        System.out.print("Enter the key : ");key = scan.next();
        System.out.println("Enter the name-values to be loaded into the Json file in the format name,value. Press q to end : ");
        while(true){
            nv = scan.next();
            if(nv.equals('q')) break;
            else {
    ...
    public static void main(String[] args) throws IOException{
        ...
        String path = "";
        int opt = 0;                            //option for create or read or delete
        String key;
        JSONObject obj = new JSONObject();
